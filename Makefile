SOURCES=src/game.c src/globals.c src/physics.c src/entity.c src/la.c src/util.c src/player.c
...
WASM_FLAGS=${FLAGS} -fno-builtin --target=wasm32 --no-standard-libraries -Wl,--no-entry -Wl,--allow-undefined -Wl,--export-all -DWASM
